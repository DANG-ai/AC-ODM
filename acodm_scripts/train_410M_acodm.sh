...
CONFIGS="acodm_config/data/pile.yml acodm_config/init.yml acodm_config/models/410m.yml acodm_config/eval_tasks.yml acodm_config/ddpg_410m.yml acodm_config/train_data_weights/original_pile.yml"



WANDB_GROUP="acdom_410m"
...
for SEED in ${SEEDS[@]}; do
    ...
    RUN_SPECIFIC_CONFIG="acodm_config/run_specific/${RUN_NAME}.yml"
